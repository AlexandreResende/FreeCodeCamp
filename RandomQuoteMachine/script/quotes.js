...
var quotes = `1. If you want to achieve greatness stop asking for permission. ~Anonymous
...
for (var ans = 0; ans < quotes.length; ans++){
	quotes[ans] = quotes[ans].split('~');
	//document.write(quotes[ans]+'<br/>');
}
